ridge_lasso_function =function(power,parameter_grid = 100,alpha_grid = c(seq(0,1,0.25)), cost = "cost_spent_on_exposed_group" , response = "absolute_lift", data = Search_data) {
  alpha = alpha_grid
